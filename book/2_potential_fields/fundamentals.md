...
As you should recall from previous courses, the work performed by a force is given by the product of the force applied on and object and the distance traveled by the object in the direction of the force (assuming the force is constant for now). For a force pointing in the $\hat{x}$ direction a and a displacement $\Delta x$ also in the x direction, the work would be given by
